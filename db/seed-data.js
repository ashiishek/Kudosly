...
const employeeResult = db.employees.insertMany([
  ...
  {
    _id: ObjectId("607f1f77bcf86cd799439000"),
    name: "Alice Johnson",
    email: "alice@kudosly.com",
    password: "password123",
    ...
    bio: "Passionate developer with diverse skills",
    skills: ["TypeScript", "React", "Node.js", "MongoDB", "AWS"],
    recognitionCount: 18,
    badgeCount: 4,
    totalEffortScore: 142,
    lastActivityDate: new Date()
  },
  {
    _id: ObjectId("607f1f77bcf86cd799439001"),
    name: "Bob Smith",
    email: "bob@kudosly.com",
    password: "password123",
    ...
    bio: "Design thinking enthusiast and creative leader",
    skills: ["Figma", "UI/UX", "Branding", "Prototyping", "Design Systems"],
    recognitionCount: 14,
    badgeCount: 3,
    totalEffortScore: 108,
    lastActivityDate: new Date(Date.now() - 86400000)
  }
]);
